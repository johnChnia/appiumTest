...
public class WeiXinFriendsTest extends UserBaseTest {
	User user;
	...
	public void loginWithValidUser() throws InterruptedException {
		...
		welcomePage.waitForWelcomePage().swipeLeftToLoginPage(5)
				...
				.enterAccountPage().waitForAccountPage().enterSharePage()
				.waitForSharePage().shareByWeiXinFriends()
				.waitForWeixinFriendsPage().share("cheney");
	}
}
